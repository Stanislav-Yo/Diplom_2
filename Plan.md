...
7. Нажать кнопку "Продолжить"
    * _Ожидаемый результат_: появляется сообщение об успешной покупке: "Операция одобрена Банком."
...
**Сценарий 17**: Оплата тура в кредит со статусом APPROVED и валидными данными
...
**Сценарий 18**: Оплата тура в кредит со статусом DECLINED и валидными данными
...
**Сценарий 19**: Оплата тура в кредит по несуществующей карте
...
**Сценарий 20**: Попытка платы тура в кредит с вводом латинских букв в поле номера карты
...
**Сценарий 21**: Попытка оплаты тура в кредит с вводом специальных символов в поле номера карты
...
**Сценарий 22**: Попытка оплаты тура в кредит с неверно заполненным полем имени
...
**Сценарий 23**: Попытка оплаты тура в кредит с незаполненным полем имени
...
**Сценарий 24**: Попытка оплаты тура в кредит с незаполненным полем месяца
...
**Сценарий 25**: Попытка оплаты тура в кредит с несуществующим месяцем
...
**Сценарий 26**: Попытка оплаты тура в кредит с неверно заполненным полем месяца
...
**Сценарий 27**: Попытка оплаты тура в кредит с пустым полем года
...
**Сценарий 28**: Попытка оплаты тура в кредит с неверно заполненным полем года
...
**Сценарий 29**: Попытка оплаты тура в кредит с истекшим сроком действия
...
**Сценарий 30**: Попытка оплаты тура в кредит со сроком действия более 5 лет
...
**Сценарий 31**: Попытка оплаты тура в кредит с указанием месяца "00"
...
**Сценарий 32**: Попытка оплаты тура в кредит с неверно заполненным полем CVC/CVV
